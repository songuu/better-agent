...
const EXPECTED_POSTGRES_SUITES = Object.freeze([
  ...
  Object.freeze({
    ...
    sha256: '0e7921407f5e5a830e58090b8496fc93d778a36a0206882e0c7a99879ed1e549',
  ...
  Object.freeze({
    ...
    sha256: '4402fcb930ec148ae2513edf593be20b2229851b48e60795bfc41585cb44bd45',
...
const EXPECTED_WORKSPACE_TESTS = Object.freeze([
  ...
  Object.freeze({
    ...
    script: 'vitest run --config vitest.config.ts --configLoader native',
    testCount: 188,
    successMarker: '@better-agent/db:test:       Tests  188 passed (188)',
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    script: 'vitest run --config vitest.config.ts --configLoader native',
    testCount: 102,
    successMarker: '@better-agent/web:test:       Tests  102 passed (102)',
  }),
]);
