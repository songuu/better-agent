...
const REQUIRED_EVIDENCE_DOMAINS = Object.freeze([
  ...
  'product-agent-strategy-profile',
  'product-async-subagent',
  'product-plugin-catalog',
  'product-custom-plugin',
  'product-custom-api',
  'product-skill-pack',
  'product-mcp-server',
  'runtime-security',
...
const EXPECTED_POSTGRES_SUITES = Object.freeze([
  ...
  Object.freeze({
    id: 'product-flow-studio',
    file: 'infra/test/postgres/run-product-flow-studio-integration.mjs',
    sha256: '8012313c8cac667766336af179abc2bbf077902af3410146e4e2a55118caba60',
    successMarker: 'architecture-gate-suite/1 product-flow-studio pass',
  }),
  Object.freeze({
    id: 'product-knowledge-center',
    file: 'infra/test/postgres/run-product-knowledge-center-integration.mjs',
    sha256: '592cc7ba76dc23834ae686d4bb16a4555a902114362922cd5eb442fe0550b36f',
    successMarker: 'architecture-gate-suite/1 product-knowledge-center pass',
  }),
  Object.freeze({
    id: 'product-agent-knowledge',
    file: 'infra/test/postgres/run-product-agent-knowledge-binding-integration.mjs',
    sha256: '6be9e5f91b4d2eef8827bca0c85a311433e7538b9b8ab80a96d826daeb529594',
    successMarker: 'architecture-gate-suite/1 product-agent-knowledge pass',
  }),
  Object.freeze({
  ...
  Object.freeze({
    id: 'product-database-studio',
    file: 'infra/test/postgres/run-product-database-studio-integration.mjs',
    sha256: '6fe3c84f3d2e227be1ce4f72f9e18164fa7de9eab8f1fd5c24794720a73d33be',
    successMarker: 'architecture-gate-suite/1 product-database-studio pass',
  }),
  Object.freeze({
    id: 'product-database-operation',
    file: 'infra/test/postgres/run-product-database-operation-integration.mjs',
    sha256: '13a57b3ca8095669a0d3c50052263eef43efb32e4fb4783845b2f9be76a22025',
    successMarker: 'architecture-gate-suite/1 product-database-operation pass',
  }),
  Object.freeze({
    id: 'product-agent-database',
    file: 'infra/test/postgres/run-product-agent-database-binding-integration.mjs',
    sha256: '8c46b6c03c282212138f67c322fcf50916da7d1880689cd050d4d1c54388642a',
  ...
  Object.freeze({
    id: 'product-plugin-catalog',
    file: 'infra/test/postgres/run-product-plugin-catalog-integration.mjs',
    sha256: '1b73ff62913ce1b7936450a0c3e171bd246a4a09139099489da40324e76a7f1b',
    successMarker: 'architecture-gate-suite/1 product-plugin-catalog pass',
  }),
  Object.freeze({
    id: 'product-custom-plugin',
    file: 'infra/test/postgres/run-product-custom-plugin-integration.mjs',
    sha256: '4a77b7e2c23000940a0e3e5ef3323c7e9839034ab91e63e50f32ed732c8ac47e',
    successMarker: 'architecture-gate-suite/1 product-custom-plugin pass',
  }),
  Object.freeze({
    id: 'product-custom-api',
    file: 'infra/test/postgres/run-product-custom-api-integration.mjs',
    sha256: 'a539bf7f0ba172a4e74712d478b47b6e1d8467ecf006334ceb725f00f76d76ad',
    successMarker: 'architecture-gate-suite/1 product-custom-api pass',
  }),
  Object.freeze({
    id: 'product-skill-pack',
    file: 'infra/test/postgres/run-product-skill-pack-integration.mjs',
    sha256: '4c4d720547ac81fd04a00c9fb373cb60d95aba8f10002f7056299f4386ccaef7',
    successMarker: 'architecture-gate-suite/1 product-skill-pack pass',
  }),
  Object.freeze({
    id: 'product-mcp-server',
    file: 'infra/test/postgres/run-product-mcp-server-integration.mjs',
    sha256: 'b576405cee1f6182e8186b3f0367624ea122625e812311ddab9dcb268d6c5142',
    successMarker: 'architecture-gate-suite/1 product-mcp-server pass',
  }),
  Object.freeze({
    id: 'runtime-security',
...
const EXPECTED_POSTGRES_SUPPORT_FILES = Object.freeze([
  ...
  Object.freeze({
    ...
    sha256: 'e4094653a2c18312b4f2555cfc9947a1e5dc42e38e07fca7dded38261d8b41c7',
  }),
  Object.freeze({
...
const EXPECTED_WORKSPACE_TESTS = Object.freeze([
  Object.freeze({
    packageName: '@better-agent/agent-runtime',
    script: 'vitest run --config vitest.config.ts --configLoader native',
    testCount: 15,
    successMarker: '@better-agent/agent-runtime:test:       Tests  15 passed (15)',
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    script: 'vitest run --config vitest.config.ts --configLoader native',
    testCount: 223,
    successMarker: '@better-agent/db:test:       Tests  223 passed (223)',
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    script: 'vitest run --config vitest.config.ts --configLoader native',
    testCount: 144,
    successMarker: '@better-agent/web:test:       Tests  144 passed (144)',
  }),
  Object.freeze({
    packageName: '@better-agent/worker',
    script: 'vitest run --config vitest.config.ts --configLoader native',
    testCount: 25,
    successMarker: '@better-agent/worker:test:       Tests  25 passed (25)',
  }),
]);
...
const EXPECTED_GATE_COMMANDS = Object.freeze([
  ...
  Object.freeze({
    ...
    timeoutMs: 300_000,
    successMarkers: Object.freeze([
      'workspace smoke passed for 15 package(s)',
