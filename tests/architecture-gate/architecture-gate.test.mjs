...
test('requires one semantic, successful result for every registered gate', () => {
  ...
  const postgresSuccessLines = [
    ...
    'architecture-gate-suite/1 product-flow-studio pass',
    'architecture-gate-suite/1 product-knowledge-center pass',
    'architecture-gate-suite/1 product-agent-knowledge pass',
    'architecture-gate-suite/1 product-release-evaluation pass',
    'architecture-gate-suite/1 product-database-studio pass',
    'architecture-gate-suite/1 product-database-operation pass',
    'architecture-gate-suite/1 product-agent-database pass',
    'architecture-gate-suite/1 product-agent-role-profile pass',
    'architecture-gate-suite/1 product-agent-strategy-profile pass',
    'architecture-gate-suite/1 product-async-subagent pass',
    'architecture-gate-suite/1 product-plugin-catalog pass',
    'architecture-gate-suite/1 product-custom-plugin pass',
    'architecture-gate-suite/1 product-custom-api pass',
    'architecture-gate-suite/1 product-skill-pack pass',
    'architecture-gate-suite/1 product-mcp-server pass',
